...
}(require("../../service/order.js")), r = require("../../utils/api.js"), o = require("../../utils/monitor/monitor.js"), n = getApp();
...
Page({
    ...
    setOrderParam: function() {
        var t = this.data.walletParam, a = this.data.orderParam;
        if (a && null != a.productList) {
            for (var r = 0; r < a.productList.length; r++) for (var o = a.productList[r], n = 0; n < t.productList.length; n++) {
    ...
    selectProduct: function(a) {
        ...
        try {
            for (var i, l = r[Symbol.iterator](); !(o = (i = l.next()).done); o = !0) {
                var s = i.value;
    ...
    onLoad: function(t) {
        this.getOrderParam(), this.getProductList(), o.onLoad(this);
    },
    onReady: function() {},
    onShow: function() {
        this.getWalletParam();
